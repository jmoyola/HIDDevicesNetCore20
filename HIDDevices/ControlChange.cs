...
public readonly struct ControlChange : IEquatable<ControlChange>
{
    ...
    /// <inheritdoc />
    public override int GetHashCode() => Control.GetHashCode() | PreviousValue.GetHashCode() | Value.GetHashCode();
    ...
    /// <summary>
    ///     Performs an implicit conversion from <see cref="ControlChange" /> to <see cref="double" />.
    /// </summary>
    ...
    /// </summary>
    /// <returns></returns>
    internal ControlChange Reset() => new(Control, double.NaN, Value, Timestamp);
}
